...
<head>
    ...
    <title>HTK Interior Design About Us Page</title>

    <!-- jquery link -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>

    <!-- CSS files -->
    <link rel="stylesheet" href="website-stylesheet/home.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <main id="home" class="home">
        <div class="image-container">
            ...
            <p>Crafting Elegance, One space at a time.</p>
            <div class="btn-container"><button class="contact-us-btn contact-form-btn">Contact Us</button></div>
            </section>
        </div>
    </main>
